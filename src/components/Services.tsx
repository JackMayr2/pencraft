        ...
        <section id="services" className="py-24 bg-secondary/10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto">
                    ...
                    <p className="section-title">Comprehensive Email Solutions</p>
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            <div className="flex items-start">
                                <div className="shrink-0 mr-4 mt-1 w-10 h-10 flex items-center justify-center border border-primary/30 text-primary">
                                    {service.icon}
                                </div>
                                <div>
                                    <h3 className="text-lg font-mono font-semibold text-dark mb-3 group-hover:text-primary transition-colors duration-300">
                                        {service.title}
                                    </h3>
