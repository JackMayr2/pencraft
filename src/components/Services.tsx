        ...
        <section id="services" className="py-20 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">Comprehensive Email Solutions</p>
                    <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
                        Everything you need to create, deploy, and optimize high-performing email campaigns that drive results.
                    </p>
                </div>
