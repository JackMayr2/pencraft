                    ...
                    <div className="lg:col-span-3">
                        <form className="space-y-8">
                            <div className="space-y-6">
                                <div>
                                    <label htmlFor="name" className="block text-sm font-mono text-dark mb-2">Full name</label>
                                    <input
                                        type="text"
                                        name="name"
                                        id="name"
                                ...
                                <div>
                                    <label htmlFor="email" className="block text-sm font-mono text-dark mb-2">Email address</label>
                                    <input
                                        id="email"
                                        name="email"
                                        type="email"
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-sm font-mono text-dark mb-2">Message</label>
                                    <textarea
                                        id="message"
                                        name="message"
                                        rows={5}
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="px-8 py-3 border border-primary bg-transparent text-primary font-mono text-sm hover:bg-primary hover:text-white transition-colors duration-300"
                                >
                                    Send Message
                                </button>
                            </div>
                            ...
                            <div className="space-y-8">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4 font-body">
                                        ...
                                        <p className="text-dark/60 text-sm mt-1">Mon-Fri 9am-6pm EST</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4 font-body">
                                        <p className="text-dark">hello@pigeonpipeline.io</p>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4 font-body">
                                        <p className="text-dark">123 Marketing Ave</p>
                                        <p className="text-dark">Suite 456</p>
