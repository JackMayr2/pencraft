            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
                    ...
                    <div className="md:col-span-3 md:ml-auto">
                        <h3 className="text-base font-mono font-semibold text-white mb-6">Services</h3>
                    ...
                    <div className="md:col-span-3">
                        <h3 className="text-base font-mono font-semibold text-white mb-6">Company</h3>
                        <ul className="space-y-4 font-body">
                            <li>
                            ...
                            <li>
                                <Link href="#work" className="text-white/70 hover:text-white transition-colors duration-300">
                                    Our Work
                                </Link>
                            </li>
                            <li>
                ...
                <div className="mt-16 pt-8 border-t border-white/10">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="mt-4 md:mt-0 flex space-x-8">
                            <Link href="#" className="text-sm text-white/70 font-mono hover:text-white transition-colors duration-300">
                                Privacy
                            </Link>
                            <Link href="#" className="text-sm text-white/70 font-mono hover:text-white transition-colors duration-300">
                                Terms
