            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="#team" className="text-gray-300 hover:text-white transition duration-300">
                                    About Us
                                </Link>
                            </li>
                            <li>
                                <Link href="#work" className="text-gray-300 hover:text-white transition duration-300">
                                    Our Work
                                </Link>
                            </li>
                            <li>
